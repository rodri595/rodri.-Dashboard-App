    ...
    <div className="sidebar__wrapper">
      <div className="sidebar__inner">
        <a className="sidebar__logo" href="/">
          <img className="sidebar__pic" src={logosm} alt="figure 1" />
        </a>
        <div className="sidebar__list">
          <div className="sidebar__group">
            ...
            <div className="sidebar__menu">
              <a className="sidebar__item active" href="/">
        ...
        <div
          ...
          onClick={() => setisuserTab((prev) => !prev)}
        >
          <div
            className="sidebar__details"
            style={{ display: `${isuserTab ? "block" : "none"}` }}
          >
            <a className="sidebar__link">
              <div className="sidebar__icon">
                <svg className="icon icon-profile">
                  <path d="M8.242 12.907l.33.001.323.004.626.017c4.296.162 6.714 1.202 6.714 3.704 0 2.737-2.89 3.706-7.992 3.706h-.33l-.64-.01C2.784 20.204.25 19.176.25 16.613c0-2.738 2.887-3.706 7.992-3.706zm0 1.5l-.343.002-.658.013-.622.026-.585.04-.548.052c-2.472.272-3.737.966-3.737 2.075 0 1.155 1.36 1.868 4.01 2.122l.566.046 1.917.06.676-.006.64-.02c3.418-.143 5.176-.874 5.176-2.18 0-1.155-1.36-1.868-4.01-2.122l-.566-.046-.603-.033-.64-.02-.675-.007zm0-14.157c2.99 0 5.392 2.4 5.392 5.392s-2.4 5.392-5.392 5.392S2.85 8.632 2.85 5.642 5.252.25 8.242.25zm0 1.5C6.08 1.75 4.35 3.48 4.35 5.642s1.73 3.892 3.892 3.892 3.892-1.73 3.892-3.892-1.73-3.892-3.892-3.892z" />
                </svg>
              </div>
          ...
          <a className={`sidebar__user ${isuserTab ? "active" : ""}`}>
            <div className="sidebar__ava">
              <img className="sidebar__pic" src={AvatarRod} alt="figure 1" />
            </div>
            <div className="sidebar__desc">
              <div className="sidebar__man">John Doe</div>
              <div className="sidebar__status caption">root</div>
            </div>
